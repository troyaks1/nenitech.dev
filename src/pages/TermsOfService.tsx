    ...
    <div className="space-y-8 text-gray-300 leading-relaxed">
      <div>
        <p>
          ...
          registered in the United States, with its principal place of business at 5900 Balcones Dr Ste 100,
          Austin, TX 78731. This includes our website{' '}
    ...
    <div className="space-y-8 text-gray-300 leading-relaxed">
      <div>
        <p>
          ...
          registrada nos Estados Unidos, com sede em 5900 Balcones Dr Ste 100,
          Austin, TX 78731. Isso inclui nosso website{' '}
